...
# =============================================================================
# GovOps Platform — Quick Verification Script
# Runs lint, type-check, unit tests, and manifest validation.
# =============================================================================
...
if command -v docker &>/dev/null && docker info &>/dev/null 2>&1; then
    run_check "Docker build" docker build -f Dockerfile.prod -t govops-platform:verify --quiet .
fi
