...
if [[ "${SECCOMPOPS_RUN_MIGRATIONS:-false}" == "true" ]]; then
...
if [[ $# -gt 0 ]]; then
    ...
    WORKERS="${SECCOMPOPS_WORKERS:-4}"
    PORT="${SECCOMPOPS_PORT:-8095}"
