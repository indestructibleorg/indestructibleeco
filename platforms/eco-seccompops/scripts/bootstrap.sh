...
# =============================================================================
# SecCompOps Platform — Bootstrap Script
# =============================================================================
...
if command -v docker &>/dev/null && docker info &>/dev/null 2>&1; then
    while ! docker compose exec -T postgres pg_isready -U seccompops &>/dev/null 2>&1; do
...
echo ""
echo "  SecCompOps Platform — Development Environment Ready"
echo "  Activate:  source ${VENV_DIR}/bin/activate"
echo "  Run API:   seccompops"
